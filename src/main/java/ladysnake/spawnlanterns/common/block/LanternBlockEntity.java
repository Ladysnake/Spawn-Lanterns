...
public abstract class LanternBlockEntity extends BlockWithEntity implements Waterloggable {
    ...
    public LanternBlockEntity(AbstractBlock.Settings settings) {
        super(settings);
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        Direction direction = LanternBlockEntity.attachedDirection(state).getOpposite();
    ...
    public BlockState getStateForNeighborUpdate(BlockState state, Direction direction, BlockState neighborState, WorldAccess world, BlockPos pos, BlockPos neighborPos) {
        ...
        if (LanternBlockEntity.attachedDirection(state).getOpposite() == direction && !state.canPlaceAt(world, pos)) {
